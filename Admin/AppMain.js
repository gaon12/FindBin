...
export default function AppMain() {
  ...
  const fetchData = async (checkNextPage = false) => {
    ...
    let response;
    try {
      response = await axios.post('https://findbin.uiharu.dev/app/api/AppInquiry/AppInquiry.php', requestData);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.modalContainer}>
          ...
          >
            <Text style={[styles.buttonText, isAnswering && styles.disabledButtonText]}>이미지 선택</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.AnswerButton, isAnswering && styles.disabledButton]}
            onPress={Answer}
            disabled={isAnswering}
          >
            <Text style={[styles.buttonText, isAnswering && styles.disabledButtonText]}>답변</Text>
          </TouchableOpacity>
          <TouchableOpacity
